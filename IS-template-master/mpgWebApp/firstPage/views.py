...
def index(request):
    ...
    for i in match_list:
        home = i['fields']['homename']
        away = i['fields']['awayname']
        resultHome = df_resultHome[(df_resultHome['HomeTeam'] == 'Bayern Munich')] # == home
        resultAway = df_resultAway[(df_resultAway['AwayTeam'] == 'Bayern Munich')] # ==away
